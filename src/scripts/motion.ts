/**
 * Lightweight motion layer (performance pass) — framework-free.
 *
 ...
 *  3. `[data-hero-media]` / `[data-hero-copy]` — one-shot CSS "settle"
 *                                  on load (transform only; paint happens
 *                                  immediately — LCP-safe by design).
 *  4. Menu open/close transition — orchestrated in src/scripts/menu.ts.
 *  5. Button/link micro-interactions — pure CSS (global.css).
 *
